...
from models import FullBasicModel, FullBasicModel1, gstarhat, gstarhat1
...
def train(args: Namespace) -> None:
    ...
    for simu in range(0, 50):
        ...
        train_set = GetData(XX_tensor[0:args.n_timepoints, ...],
                            Y_tensor[:, 1:(args.n_timepoints + 1)])
    ...
    logger.info(f'Final Cpcout: {json.dumps(coverage_probability_count.tolist())}')
